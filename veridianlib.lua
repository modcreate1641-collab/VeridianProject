...
function WindowAPI:CreateTab(name, target, isAuto)
    ...
    function TabAPI:CreateSlider(cfg)
        ...
        -- ขยายกรอบนอกให้ใหญ่ขึ้นเพื่อรองรับแถบสไลเดอร์เบิ้มๆ
        ...
        -- ปรับขนาดความกว้างขึ้น 3 เท่า (จากเดิมหนา 6 เป็นหนา 18) และเซ็ตให้มนเป็นแคปซูล
        ...
        -- จังหวะกดลาก ให้ปุ่มมันขยายแอคทีฟขึ้นมานิดนึง
        ...
        -- จังหวะปล่อยมือ เด้งดึ๋งด้วย Elastic สแนปกลับทรงเดิมทันที!
    ...
    local function RenderSettings()
        ...
        UIListLayout.Padding = UDim.new(0, 8) -- เพิ่มสเปซให้ดูไม่อึดอัด
        ...
        -- อนิเมชั่นเด้งๆ ตอนเอาเมาส์ชี้และกด
        ...
        kb.MouseButton1Click:Connect(function()
            ...
            title.TextColor3 = ColorOn -- เปลี่ยนสีเตะตาตอนรอรับค่า
            ...
            bindConnection = UserInputService.InputBegan:Connect(function(input, gpe)
                if not gpe and input.UserInputType == Enum.UserInputType.Keyboard then
                    ...
                    title.TextColor3 = Color3.new(1, 1, 1) -- คืนสีเดิม
                    isListening = false
                    if bindConnection then
                        bindConnection:Disconnect()
                        bindConnection = nil
        ...
        local function BuildDrop(name, getOpts, cb)
            ...
            local function RefreshOptions()
                ...
                for _, o in ipairs(opts) do
                    ...
                    btn.MouseButton1Click:Connect(function()
                        open = false
                        CreateTween(df, {Size = closedSize}, 0.4, Enum.EasingStyle.Elastic) -- หดแบบเด้งๆ
            ...
            mb.MouseButton1Click:Connect(function()
                ...
                CreateTween(df, {Size = targetSize}, 0.4, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out) -- กางแบบเด้งดึ๋ง
    ...
    TopSettingBtn.MouseButton1Click:Connect(function() 
        if SearchBox then SearchBox.Text = "" end -- เคลียร์ช่องค้นหาเวลาเปิด
        for _, v in pairs(PageArea:GetChildren()) do 
            if v.Visible then 
                CreateTween(v, {BackgroundTransparency = 1, Position = UDim2.new(0, 20, 0, 0)}, 0.15).Completed:Connect(function() v.Visible = false end) 
            end
